...
namespace prep.specs
{
  ...
  public class MovieLibrarySpecs
  {
    ...
    public class when_searching_for_movies : concern_for_searching_and_sorting
    {
      ...
      {
        var results = sut.all_movies().all_matching(Movie.is_published_by(ProductionStudio.Pixar));
      ...
      It should_be_able_to_find_all_movies_published_by_pixar_or_disney = () =>
      {
        var condition = Movie.is_published_by(ProductionStudio.Pixar)
                             .or(Movie.is_published_by(ProductionStudio.Disney));

            var results = sut.all_movies().all_matching(condition);
